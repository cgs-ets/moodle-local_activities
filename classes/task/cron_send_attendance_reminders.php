...
class cron_send_attendance_reminders extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('cron_send_attendance_reminders', 'local_activities');
    }
    ...
    protected function send_reminder($activity, $recipient) {
        ...
        $messageHtml = $OUTPUT->render_from_template('local_activities/email_attendance_reminder_html', $activity);
