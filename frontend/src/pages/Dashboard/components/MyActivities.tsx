                      ...
                      <div>
                        { !!Number(event.isallday)
                          ? dayjs.unix(Number(event.timestart)).format("DDMM") == dayjs.unix(Number(event.timeend)).format("DDMM") 
                            ? <div className='text-sm'>All day {dayjs.unix(Number(event.timestart)).format("DD MMM")}</div>
                            : <div className='text-sm'>All day {dayjs.unix(Number(event.timestart)).format("DD MMM")} - {dayjs.unix(Number(event.timeend)).format("DD MMM")}</div>
                          : dayjs.unix(Number(event.timestart)).format("DDMM") == dayjs.unix(Number(event.timeend)).format("DDMM") 
