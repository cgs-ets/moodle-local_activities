...
export const exportActivityHash = () => {
  ...
  const { status, pushpublic, studentlistjson, initialCampus, initialCocurr, initialActivitytype, initialTimestart, initialTimeend, occurrences, recurringAcceptChanges, hasUserAcknowledged, ...rest } = formData; 
