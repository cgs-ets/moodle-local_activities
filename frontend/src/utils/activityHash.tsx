...
export const exportActivityHash = () => {
  ...
  const { status, pushpublic, studentlistjson, initialCampus, initialActivitytype, initialTimestart, initialTimeend, occurrences, recurringAcceptChanges, hasUserAcknowledged, ...rest } = formData; 
